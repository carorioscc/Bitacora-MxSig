-- Function: jenks_json(text, integer, integer)

-- DROP FUNCTION jenks_json(text, integer, integer);
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION jenks_json(text, integer, integer)
  OWNER TO postgres;
GRANT EXECUTE ON FUNCTION jenks_json(text, integer, integer) TO postgres;
